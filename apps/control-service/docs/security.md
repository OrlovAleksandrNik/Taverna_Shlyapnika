...
Оставшиеся hardening-задачи: rate limit persistence, mandatory 2FA policy для OWNER/SUPERADMIN, distributed session invalidation, production mail provider.
