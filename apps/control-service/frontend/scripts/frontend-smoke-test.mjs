...
const requiredText = ["Taverna Control", "Программы мастера", "Desktop Agent", "PUBLIC_REGISTRATION_ENABLED", "hashed backup codes", "Upload policy", "Колонки", "Export", "API_BASE", "Data:", "data-action=\"login\"", "data-action=\"create-record\"", "data-action=\"project-launch\"", "data-action=\"backup-create\"", "X-XSRF-TOKEN"];
