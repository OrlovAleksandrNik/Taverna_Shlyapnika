...
Создание игры уже работает по этому потоку. Черновик пошагового диалога пока хранится в памяти Java-бота; опубликованная игра сохраняется в PostgreSQL через backend API.
