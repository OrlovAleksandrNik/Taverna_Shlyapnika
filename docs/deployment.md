...
Старый isolated-контур кабинета удалён из репозитория. Рабочая схема: основной Java backend, статический сайт и кабинет мастера собираются одним корневым Dockerfile.
## HTTPS и Telegram
